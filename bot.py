...
async def op(_, m :Message):
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            ...
            await m.reply_text("**Hello {}!\nI'm an auto approve Join Requests Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powerd By : @MovieMalonie**".format(m.from_user.mention), reply_markup=keyboard)
...
async def chk(_, cb : CallbackQuery):
    try:
        ...
        if cb.message.chat.type == enums.ChatType.PRIVATE:
            ...
            await cb.message.edit("**Hello {}!\nI'm an auto approve Join Request Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powerd By : @MovieMalonie**".format(cb.from_user.mention), reply_markup=keyboard, disable_web_page_preview=True)
